...
public class HelpRequestControllerTests extends ControllerTestCase{
    ...
    @Test
    public void logged_in_users_can_getall() throws Exception{
        mockMvc.perform(get("/api/helprequest/all"))
    ...
    public void an_admin_user_can_post_a_new_helprequest() throws Exception {
        ...
        MvcResult response = mockMvc.perform(
                        post("/api/helprequest/post?requesterEmail=myly@ucsb.edu&teamId=s22-6pm-3&tableOrBreakoutRoom=table&requestTime=2022-01-03T00:00:00&explanation=errors&solved=true")
                                        .with(csrf()))
                        .andExpect(status().isOk()).andReturn();
